...
clear all;
path(path,'C:\SkyDrive\SOFTWARE\Mylake_v12_package\air_sea') %path for air-sea toolbox
path(path,'C:\SkyDrive\SOFTWARE\Mylake_v12_package\v12') %path for MyLake model code

global ies80 Eevapor;
test_time=0;
Eevapor=0;

load C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\Observations\vansjoice.dat
load C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\Observations\vansjotemp.dat 

[Obs_TP_Chla, trash]=xlsread('C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\Observations\Vansjo_TP_Chla84_05.xls');
% year, month, day, TP, Chla
load C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\Observations\Obs_SS.dat; 
% year, month, day, SS (mg/L)
load C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\Observations\Obs_PO4P.dat; 
...
initfile='C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\VAN_init_v12.xls';
parafile='C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\VAN_para_v12.xls';
inputfile='C:\SkyDrive\SOFTWARE\Mylake_v12_package\Vansjo_application\VAN_input_PGS84_00_v12.xls';
